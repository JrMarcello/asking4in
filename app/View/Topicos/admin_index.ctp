<div class="topicos index">
	...
	<tr>
		<td><?php echo h($topico['Topico']['id']); ?>&nbsp;</td>
		<td><?php echo h($topico['Topico']['descricao']); ?>&nbsp;</td>
		<td><?php echo h($topico['Topico']['nome']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($topico['Tema']['nome'], array('controller' => 'temas', 'action' => 'view', $topico['Tema']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $topico['Topico']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $topico['Topico']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $topico['Topico']['id']), null, __('Are you sure you want to delete # %s?', $topico['Topico']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
